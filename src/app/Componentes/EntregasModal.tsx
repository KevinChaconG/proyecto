                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', gap: '1rem' }}>
                  <div>
                    ...
                    <div className="small">
                      Fecha entrega:{' '}
                      {e.fecha_entrega
                        ? new Date(e.fecha_entrega).toLocaleString()
                        : '—'}
                    </div>
                    {e.comentario_estudiante && (
                      <div className="small">
                        Comentario: {e.comentario_estudiante}
                      </div>
                    )}
                  </div>
                  ...
                  <div style={{ textAlign: 'right' }}>
                    <div className="small mb-1">
                      <span
                        style={{
                          ...
                          fontWeight: 600,
                          backgroundColor:
                            e.estado === 'calificada' ? '#d1fae5' : '#fef3c7',
                          color: e.estado === 'calificada' ? '#166534' : '#92400e',
                        }}
                      >
                        {e.estado}
                      </span>
                    ...
                    <div style={{ marginTop: '0.5rem' }}>
                      ...
                      >
                        {e.calificacion ? 'Editar' : 'Calificar'}
                      </button>
                    </div>
                  </div>
                </div>
